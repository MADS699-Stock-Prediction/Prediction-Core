...
def extract_gnews_sentiment(stock_id =['TSLA'], start_date ='02/01/2020', 
                            end_date ='02/01/2022',
                                 ...
                                 clean_tech_data_store_dir='data/googlenewsdata/'
                                 ):
...
# as of now sentiment from pygooglenews only
        ...
        file_path_gnews_with_sentiment = clean_tech_data_store_dir + "/googlenewsdata_gnews_" + id + "_"+start_date +"_" +end_date

        print(file_path_gnews_with_sentiment)
        df.to_csv(file_path_gnews_with_sentiment)
...
if __name__ == '__main__':
    ...
    print(args)
    extract_gnews_sentiment(stock_id=args.stock_ids, 
