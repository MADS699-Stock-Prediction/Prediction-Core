...
def evaluate_model(stock_id =['TSLA'], 
    ...
    model = keras.models.load_model(model_storage_path)
    ...
    log_metrics(stock_tickr, 'LSTM_Univariate_model_evaluate', rmse, r2, mape, smape)
    ...
    plot =data_frame.plot(title = (stock_tickr + str(current_time) +"_trend_evaluation_by_model"+ model_storage_path)).get_figure()
    save_path = 'data/visualization/' + stock_tickr + str(current_time) + \
          "_Vanilla_LSTM(univariate_Close_Evaluation) real vs predicted"
...
if __name__ == '__main__':
    ...
    print(args)
    evaluate_model(stock_id=args.stock_ids, 
